...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    this is VIP_Category
                   DESC

  s.homepage     = "https://github.com/CaiJinQuan/VIP_Category"
  ...
  s.source       = { :git => "https://github.com/CaiJinQuan/VIP_Category.git", :tag => s.version.to_s }
  ...
  s.source_files  = "VIP_Category/VIP_Category/**/*.{h,m}"
